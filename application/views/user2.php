    ...
    $.get(url, function(data){
        ...
        $.each(data_komite['data_komite'], function (i,d) {
           ...
           $.each(d, function(j, e) 
            ...
            row+='<td><button class="btn btn-sm btn-default" data-toggle="modal" data-target="#editKomiteModal'+d['id']+'">UPDATE</button> <a class="btn btn-sm btn-danger delete" href="admin/print/'+d['id']+'">PRINT</a> </td>'
            console.log(d['id']);
           row+='</tr>';
